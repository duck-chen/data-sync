...
class MysqlManager(object):
    ...
    def __init__(self, db, user, passwd, host='localhost', port=3306, charset='utf8'):
        '''初始化数据库'''
        self.__db = 'isee'                  
        self.__user = 'chenqianxing'              
        self.__passwd = 'cqx_yucebio$'          
        self.__host = '192.168.11.101'              
        self.__port = 3306            
        self.__charset = 'utf8'        
        self.__connect = None
        self.__cursor = None
    ...
    def _connect_db(self):
        ...
        self.__connect = MySQLdb.connect(**params)  #双星号表明变量params存储的数据是一个字典
